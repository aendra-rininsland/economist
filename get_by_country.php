...
foreach ($newArray as $event){
	...
	$ccolor = find_color($event['Country'], $cd_array);
	
	if ($event['Country'] == 'null'){
		$event['Country'] = '(Currently unallocated)';
		unset($event);
	} else {
	...
	$final['children'][$event['Country']]['data']['$area'] += $size;
	
	if (!isset($final['children'][$event['Country']]['children'][$event['Discipline']])) {
		$final['children'][$event['Country']]['children'][$event['Discipline']] = array(
		...
		$final['children'][$event['Country']]['children'][$event['Discipline']]['data']['$area'] += $size;	
	
	if (!isset($final['children'][$event['Country']]['children'][$event['Discipline']]['children'][$event['Event']])) {
			$final['children'][$event['Country']]['children'][$event['Discipline']]['children'][$event['Event']] = array(
	...
	$final['children'][$event['Country']]['children'][$event['Discipline']]['children'][$event['Event']]['data']['$area'] += $size;
	
	$final['children'][$event['Country']]['children'][$event['Discipline']]['children'][$event['Event']]['children'][] = array(
			'children' => array(),	
			"name" => $event['Medal'],
			"id" => '' . $event['id'] . '',
			"data" => array(
