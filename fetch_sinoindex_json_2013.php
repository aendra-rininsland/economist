...
// Set your CSV feed
$feed = 'https://docs.google.com/spreadsheet/pub?key=0Aqqh1cRUSxC-dG5JQ3BDeUxGU2ZmSEc3ODNmaldQWVE&output=csv';
				...
				if (!isset($final['children'][$company['Company']]['name'])) {
					$final['children'][$company['Company']] = array(
						...
						"data" => array(
							...
							'Weight2013' => round($company['Weight2013'], 2),
							'Weight2012' => round($company['Weight2012'], 2),
							'Weight2011' => round($company['Weight2011'], 2),
